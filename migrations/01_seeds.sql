...
CREATE TABLE properties (id,owner_id,title,escription,thumbmail_photo_url,cover_photo_url,cost_per_night,parking_spaces,number_of_bathrooms,number_of_bedrooms,country,street,city,province,post_code,active)
...
CREATE TABLE reservations (id,start_date,end_date,property_id,guest_id)
VALUES (1, '2018-09-11', '2018-09-26', 2, 3),
(1, '2019-01-04', '2019-02-01', 2, 2),
(1, '2021-10-01', '2021-10-14', 1, 4),
(1, '2014-10-21', '2014-10-21', 3, 5),
(1, '2016-07-17', '2016-08-01', 3, 4),
(1, '2018-05-01', '2018-05-27', 4, 8),
(1, '2022-10-04', '2022-10-23', 5, 1),
(1, '2015-09-13', '2015-09-30', 6, 8),
(1, '2023-05-27', '2023-05-28', 4, 2),
(1, '2023-04-23', '2023-05-02', 8, 1);

CREATE TABLE property_reviews (id,guest_id,property_id,reservation_id,rating,message)
